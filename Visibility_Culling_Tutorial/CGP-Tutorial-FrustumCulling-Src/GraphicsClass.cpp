...
bool GraphicsClass::Initialize(int screenWidth, int screenHeight, HWND hwnd)
{
	...
	// 모델 객체 초기화
	if(!m_Model->Initialize(m_Direct3D->GetDevice(), L"./data/seafloor.dds", L"./data/sphere.txt"))
	{
	...
	// 모델 목록 객체 초기화
	if(!m_ModelList->Initialize(NUM_SPHERE))
	{
...
bool GraphicsClass::Frame(float rotationY, int fps, int cpu)
{
	bool result;
