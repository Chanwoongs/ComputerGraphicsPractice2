...
//	m_Light->SetDirection(1.0f, 0.0f, 0.0f);
	...
	// Texture shader 와 Light shader 2개 사용 중이다.
	// 2D Image는 Light 효과를 받지 않는다.
	...
	// Initialize the bitmap object. 판떼기를 여러개 만들려면 여러개를 만들어야한다. 하나의 Object에 여러개 Texture를 붙히는 방법도 있다.
